...
var _linksCache = [
    {path: [1, 2], kind: 'trip'},
    {path: [4, 2], kind: 'trip'},
    {path: [2, 5, 6], kind: 'horse trip'},
    {path: [4, 5], kind: 'just_line'},
    {path: [1, 2, 5], kind: 'horse trip'}
];
...
module.exports = function(app, db) {
    ...
    app.get('/graph/:id', function(req, res, next) {
        ...
        const result = {
            ...
            links: [
                {id: 1, nodes: [0, 1], kind: 'friendship'},
                {id: 2, nodes: [0, 2], kind: 'friendship'},
                {id: 3, nodes: [0, 3], kind: 'family'},
                {id: 4, nodes: [0, 6], kind: 'family'},
                {id: 5, nodes: [0, 8], kind: 'friendship'},
                {id: 6, nodes: [1, 8], kind: 'friendship'},
                {id: 7, nodes: [1, 4], kind: 'friendship'},
                {id: 8, nodes: [1, 6], kind: 'friendship'},
                {id: 9, nodes: [2, 6], kind: 'colleague'},
                {id: 10, nodes: [2, 9], kind: 'colleague'},
                {id: 11, nodes: [3, 8], kind: 'colleague'},
                {id: 12, nodes: [3, 9], kind: 'colleague'},
                {id: 13, nodes: [4, 5], kind: 'colleague'},
                {id: 14, nodes: [4, 8], kind: 'friendship'},
                {id: 15, nodes: [5, 6], kind: 'friendship'},
                {id: 16, nodes: [6, 10], kind: 'friendship'},
            ]
        };
